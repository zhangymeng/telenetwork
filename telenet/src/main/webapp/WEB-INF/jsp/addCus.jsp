...
<form class="layui-form" action="">
  ...
  <div class="layui-form-item">
    <div class="layui-inline">
      <label class="layui-form-label">开户手机号</label>
  ...
  <div class="layui-form-item">
    <div class="layui-inline">
      ...
      <div class="layui-input-inline">
        <input type="text" name="date" class="layui-input" lay-verify="required" id="date" placeholder="请选择出生年月日">
      </div>
    </div>
  </div>
...
form.on('submit(demo1)', function(data){
	...
	var date = data.field.date+" 00:00:00";
